    ...
    <main>
        <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
            <a href="index.php" class="d-block p-3 link-dark text-decoration-none" title="Comedor automático para bovinos" data-bs-toggle="tooltip" data-bs-placement="right">
                <img src="Imagenes/logo.png" width="40" heigth="40"/>
                ...
                <div class="row row-cols-1 row-cols-sm-2 g-5">
                    <div class="col">
                        <div class="card shadow-sm">
                             <a href="Reg_suministro.php"><img src="Imagenes/AlimentoIndividual.png" width="100%" height="255"/></a>
                            <div class="card-body">
                                <p class="card-text">Alimento suministrado a cada bovino.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            <a href="SuministroYdesperdicio.php"><img src="Imagenes/SumDesp.png" width="100%" height="255"/></a>
                            <div class="card-body">
                                <p class="card-text">Curvas de alimentación</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            <a href="Reg_Suministro_Total.php"><img src="Imagenes/manejo-comederos-bovinos.png" width="100%" height="255"/></a>
                            <div class="card-body">
                                <p class="card-text">Total de alimento suministrado.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                        <a href="Reg_desperdicios.php"><img src="Imagenes/DesperdicioA.png" width="100%" height="255"/></a>
                            <div class="card-body">
                                <p class="card-text">Total de alimento desperdiciado.</p>
                            </div>
                        </div>
                    </div>
                </div>
