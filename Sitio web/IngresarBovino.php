        ...
        $("#IngresarDatos").click(function(){
         ...
         if (Number.isNaN(Alimento1) 
          ...
          alert("Por favor, introduzca números positivos en los campos");
           ...
           if(Codigo==""){
              alert("El espacio del código no puede estar vacío");

           }
           else{
            if(Nombre==""){
                alert("Se ingresará el mismo codigo RF como nombre");
                Nombre=Codigo;
            }
            var dataString ="Nombre="+Nombre+"&RFID="+Codigo+"&Proceso="+Proceso+"&Alimento1="+Alimento1+"&Alimento2="+Alimento2+"&Contra="+Contra+"&Porciones="+Porciones;
            $.ajax
              ({
      ...
      <symbol id="Ayuda" viewBox="0 0 16 16">
        ...
        <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
            ...
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                ...
                <li>
                    <a href="IngresarBovino.php" class="nav-link active py-3 border-bottom" title="Ingresar bovino" data-bs-toggle="tooltip" data-bs-placement="right">
                ...
                <div class="row row-cols-1 row-cols-sm-2 g-5">
                    <div class="col">
                        <div class="card shadow-sm">
                             <a href="#"><img src="Imagenes/pexels-Bovino_2.jpg" data-bs-toggle="modal" data-bs-target="#Modificacion" width="100%" height="255"/></a>
                             <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modificacion">Registrar bovino</button>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="ModalLabel">Registrar bovino</h5>
          ...
          <div class="mb-1">
            ...
            <input type="text" class="form-control" id="Nombre_individuo">
          </div>
          <div class="mb-1">
            <label for="recipient-name" class="col-form-label">Código RFID:</label>
            <input type="text" class="form-control" id="Codigo_individuo">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Cantidad de alimento1:</label>
            <input type="text" class="form-control CampoNumerico" id="Alimento1_individuo">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Cantidad de alimento2:</label>
            <input type="text" class="form-control CampoNumerico" id="Alimento2_individuo">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Porciones diarias:</label>
            <input type="text" class="form-control CampoNumerico" id="Porciones">
          </div>
          <div class="mb-3">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="IngresarDatos">Guardar cambios</button>
          </div>
        </div>
      </div>
    </div>
